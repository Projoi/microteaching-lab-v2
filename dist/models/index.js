...
dotenv.config();
let sequelize;
// tentukan dia menggunakan databse production atau local?
// berdasarkan NODE_ENV di .env
if (process.env.NODE_ENV == 'production') {
    console.log("DB run on production");
    ...
    exports.sequelize = sequelize = new sequelize_1.Sequelize({
        ...
        username: "root",
        password: "181001",
        database: "virtual-lab",
        logging: false,
    });
}
// Fungsi untuk menghubungkan ke database saat server pertamakali dijalankan
